...
/*   Updated: 2018/01/20 18:45:36 by sergee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
						...
						t_point p2, int i)
{
	...
	m.x = (p0.x + p1.x + p2.x) / 3;
	m.y = (p0.y + p1.y + p2.y) / 3;
	...
	draw_line(data, p0, m, ft_hex_to_dec("0xffffff"));
	draw_line(data, p1, m, ft_hex_to_dec("0xffffff"));
	draw_line(data, p2, m, ft_hex_to_dec("0xffffff"));
	if (--i)
	{
		draw_triangle(data, p0, m, p1, i);
		draw_triangle(data, p1, m, p2, i);
		draw_triangle(data, p2, m, p0, i);
	}
	return (0);
}
